...
echo -e "        ${z}╚═════════════════════════════════════════════════╝${NC}"
echo -e "         ${z}╔═════════════════════════════════════════════════╗${NC}"
echo -e "         ${z}║ ${WH}[$blue01${WH}]${NC} $blue• ${WH}SSH-WS   ${WH}[${COLOR1}Menu${WH}]   ${WH}[$blue06${WH}]${NC} ${blue}• ${WH}RESTART SERVICE $COLOR1║ $NC"
echo -e "         ${z}║                                                 $blue║ $NC"
echo -e "         ${z}║ ${WH}[$blue02${WH}]${NC} $blue• ${WH}VMESS    ${WH}[$blueMenu${WH}]   ${WH}[$blue07${WH}]${NC} ${blue}• ${WH}REBOOT VPS      $blue║ $NC"
echo -e "         ${z}║                                                 $blue║ $NC"
echo -e "         ${z}║ ${WH}[$blue03${WH}]${NC} $blue• ${WH}VLESS    ${WH}[$blueMenu${WH}]   ${WH}[$blue08${WH}]${NC} ${blue}• ${WH}UPDATE    ${WH}[${blue}Menu${WH}]$blue║ $NC"
echo -e "         ${z}║                                                 $blue║ $NC"
echo -e "         ${z}║ ${WH}[$blue04${WH}]${NC} $blue• ${WH}TROJAN   ${WH}[$blueMenu${WH}]   ${WH}[$blue09${WH}]${NC} ${blue}• ${WH}SETTING   ${WH}[${blue}Menu${WH}]$blue║ $NC"
echo -e "         ${z}║                                                 $blue║ $NC"
echo -e "         ${z}║ ${WH}[$blue05${WH}]${NC} $blue• ${WH}ALL-XRAY   ${WH}[$blueMenu${WH}] ${WH}[${blue}10${WH}]${NC} ${blue}• ${WH}BACKUP    ${WH}[${blue}Menu${WH}]$blue║ $NC"
echo -e "         ${z}╚═════════════════════════════════════════════════╝${NC}"
DATE=$(date +'%d %B %Y')
datediff() {
    d1=$(date -d "$1" +%s)
