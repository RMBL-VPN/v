...
echo -e "      ${z}───────────────────────────────────────────────${NC}" 
echo -e " ${z}┌────────────────────────────────────────────────────────┐${NC}"
echo -e " ${z}│$NC [${COLOR1}01${WH}]${NC} ${COLOR1}• ${WH}SSH-WS   ${WH}[${COLOR1}Menu${WH}]           ${NC} ${z}│${NC}     [${COLOR1}06${WH}]${NC} ${COLOR1}• ${WH}RESTART   ${WH}[${COLOR1}Menu${WH}] ${z}│${NC}"
echo -e " ${z}│$NC [${COLOR1}02${WH}]${NC} ${COLOR1}• ${WH}VMESS    ${WH}[${COLOR1}Menu${WH}]           ${NC} ${z}│${NC}     ${G}07.)${NC} Reboot            ${NC} ${z}│${NC}"    
echo -e " ${z}│$NC [${COLOR1}03${WH}]${NC} ${COLOR1}• ${WH}VLESS    ${WH}[${COLOR1}Menu${WH}]           ${NC} ${z}│${NC}     ${G}08.)${NC} Update            ${NC} ${z}│${NC}"   
