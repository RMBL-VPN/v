...
echo -e " ${z}│$NC [${COLOR1}04${WH}]${NC} ${COLOR1}• ${WH}TROJAN   ${WH}[${COLOR1}Menu${WH}]           ${NC} ${z}│${NC}     ${G}09.)${NC} Setting           ${NC} ${z}│${NC}" 
echo -e " ${z}│$NC [${COLOR1}04${WH}]${NC} ${COLOR1}• ${WH}BOT TELE ${WH}[${COLOR1}Menu${WH}]           ${NC} ${z}│${NC}     ${G}10.)${NC} Backup            ${NC} ${z}│${NC}" 
echo -e " ${z}└────────────────────────────────────────────────────────┘${NC}"
echo -e "    ${z}┌───────────┐┌────────────────────────────────────┐${NC}"
