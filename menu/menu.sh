...
echo -e"  ${z}│$NC${WH}• City          ${COLOR1}: ${WH}$CITY"
...
echo -e "   $COLOR1└─────────────────────────────────────────────────┘${NC}"
echo -e " ${z}┌────────────────────────────────────────────────────────┐${NC}"
echo -e " ${z}│$NC [${COLOR1}01${WH}]${NC} ${COLOR1}• ${WH}SSH-WS   ${WH}[${COLOR1}Menu${WH}]      ${NC} ${z}│${NC}     ${WH}[${COLOR1}06${WH}]${NC} ${COLOR1}• ${WH}RESTART   ${WH}   ${z}│${NC}"
echo -e " ${z}│$NC [${COLOR1}02${WH}]${NC} ${COLOR1}• ${WH}VMESS    ${WH}[${COLOR1}Menu${WH}]      ${NC} ${z}│${NC}     ${WH}[${COLOR1}07${WH}]${NC} ${COLOR1}• ${WH}REBOOT   ${WH}    ${z}│${NC}"    
echo -e " ${z}│$NC [${COLOR1}03${WH}]${NC} ${COLOR1}• ${WH}VLESS    ${WH}[${COLOR1}Menu${WH}]      ${NC} ${z}│${NC}     ${WH}[${COLOR1}08${WH}]${NC} ${COLOR1}• ${WH}UPDATE    ${WH}   ${z}│${NC}"   
echo -e " ${z}│$NC [${COLOR1}04${WH}]${NC} ${COLOR1}• ${WH}TROJAN   ${WH}[${COLOR1}Menu${WH}]      ${NC} ${z}│${NC}     ${WH}[${COLOR1}09${WH}]${NC} ${COLOR1}• ${WH}SETTING   ${WH}   ${z}│${NC}" 
echo -e " ${z}│$NC [${COLOR1}04${WH}]${NC} ${COLOR1}• ${WH}BOT TELE ${WH}[${COLOR1}Menu${WH}]      ${NC} ${z}│${NC}     ${WH}[${COLOR1}10${WH}]${NC} ${COLOR1}• ${WH}BACKUP    ${WH}   ${z}│${NC}" 
echo -e " ${z}└────────────────────────────────────────────────────────┘${NC}"
echo -e "    ${z}┌───────────┐┌────────────────────────────────────┐${NC}"
